                ...
                validate.forEach(function(v){
                    switch (v){
                        case 'require':
                            ...
                            break;
                        case 'name' :
                            var name_user =  $("#name").val().split(' ');
                            if (name_user.length != 3){
                                message = 'Введите фамилью имя отчество полностью ';
                                error = true;
                            }
                            break;
                        case 'pay':
                            ...
                            break;
                        case 'password':
                            var value_password1 = $("#password").val()
                            var value_password2 = $("#passwordReply").val()
...
var Order = function(){
    ...
    if (hash === '#step4'){
                    $('#step4').removeClass('Order-block').addClass('Order-block_OPEN');
                    var r = $('#step1').addClass('Order-block').removeClass('Order-block_OPEN')
...
var ProgressPayment = function(){
    ...
    if (String(res).endsWith('online/#') || String(res).endsWith('random/#')){
        setTimeout(function (){
            $('.ProgressPayment-title').addClass('ProgressPayment-none')
            $('.ProgressPayment-green').removeClass('ProgressPayment-none')
            $('.ProgressPayment-red').removeClass('ProgressPayment-none')
            $('.cssload-thecube').addClass('ProgressPayment-none')
        }, 4000)
    }
